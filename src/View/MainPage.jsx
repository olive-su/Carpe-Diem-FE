        ...
        <>
            <ThemeProvider theme={mdTheme}>
                ...
                <Box sx={{ display: 'flex' }}>
                    <CssBaseline />
                    {/* 헤더부분(로고 들어가는 부분) */}
                    <AppBar position="absolute" open={sidebarOpen} sx={{ backgroundColor: 'white' }}>
                        <Toolbar
                            sx={{
                        ...
                        >
                            ...
                            <Box>
                                <Typography sx={{ marginRight: 2, color: "black" }}>김다솔 님</Typography>
                            ...
                            <ClickAwayListener mouseEvent="onMouseDown" touchEvent="onTouchStart" onClickAway={handleClickAway}>
                                <Box sx={{ position: 'relative' }}>
                                    ...
                                    <MenuUnstyled open={modalOpen} slots={{ root: Popper, listbox: StyledListbox }} sx={{ width: 300, marginTop: '60px', marginLeft: 1100 }}>
                    ...
                    <Drawer variant="permanent" open={sidebarOpen}>
                        ...
                        >
                            <IconButton onClick={sidebarDrawer}>
                                <ChevronLeftIcon />
                            </IconButton>
                        </Toolbar>
                        <Divider />
                    ...
                    <Box>
                        <Toolbar />
                        <Container sx={{ mt: 4, mb: 4, backgroundColor: 'white', width: 300, height: 700 }} >
                            메인페이지
